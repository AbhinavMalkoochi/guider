export default function Networkdns() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Network Dns</h1>
      <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <button data-guider="create-network-dns" className="bg-cyan-600 px-4 py-2 rounded text-sm text-white">Create New Resource</button>
        </div>
      </div>
    </div>
  )
