...
function GuiderWidget({
  ...
  const [composeValue, setComposeValue] = (0, import_react.useState)("");
  ...
  const statusTimerRef = (0, import_react.useRef)(null);
  const composeInputRef = (0, import_react.useRef)(null);
  const finishingVoiceRef = (0, import_react.useRef)(null);
  ...
  const clearVoiceSession = (0, import_react.useCallback)(() => {
  ...
  const announce = (0, import_react.useCallback)((text, duration = 2400, shouldSpeak = speak) => {
    if (liveRef.current) {
  ...
  const highlightTarget = (0, import_react.useCallback)(async (target) => {
    cleanup();
    if (!target) return;
  ...
  const finishVoiceCapture = (0, import_react.useCallback)((reason) => {
  ...
  const openComposer = (0, import_react.useCallback)((initialValue = "") => {
    setComposeValue(initialValue);
    setComposeOpen(true);
  }, []);
  const closeComposer = (0, import_react.useCallback)(() => {
    setComposeOpen(false);
    setComposeValue("");
  }, []);
  (0, import_react.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    activeStatus && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
    ...
    composeOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 10 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, letterSpacing: ".12em", textTransform: "uppercase", color: "#64748b" }, children: "Guider" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 10 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#64748b" }, children: "Cmd/Ctrl+K to open. Shift+Cmd/Ctrl+K for voice." }),
...
var GuiderContext = (0, import_react2.createContext)(null);
function GuiderProvider({ children, value }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GuiderContext.Provider, { value, children });
}
function useGuider() {
  return (0, import_react2.useContext)(GuiderContext);
}
