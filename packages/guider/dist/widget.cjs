...
function GuiderWidget({
  ...
  const [cursor, setCursor] = (0, import_react.useState)(() => ({ x: 28, y: 28 }));
  ...
  const announce = (0, import_react.useCallback)((text, duration = 2400) => {
    if (liveRef.current) {
  ...
  const highlightStep = (0, import_react.useCallback)(async (plan, index) => {
    var _a;
    cleanup();
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 16 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, letterSpacing: ".18em", textTransform: "uppercase", color: "#6b7280", marginBottom: 6 }, children: "Guider" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 22, lineHeight: 1.1, color: "#0f172a", fontWeight: 600 }, children: "Ask where something lives" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 14 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#64748b" }, children: "Press Enter to ask or click the blue cursor to use voice." }),
