...
function GuiderWidget({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { "data-guider": "guider-panel", style: panelStyle, role: "dialog", "aria-label": "Guider assistant", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "14px 16px", borderBottom: "1px solid #1c2230", display: "flex", alignItems: "center", gap: 10 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 8, height: 8, borderRadius: 4, background: accent, boxShadow: `0 0 12px ${accent}` } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontWeight: 700, letterSpacing: ".02em" }, children: "Guider" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginLeft: "auto", fontSize: 11, color: "#8b93a7" }, children: map ? `${((_a = map.pages) == null ? void 0 : _a.length) || 0} pages mapped` : "loading map\u2026" }),
        onAgentMode && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 10 }, children: [
        messages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { color: "#8b93a7", fontSize: 13, lineHeight: 1.5 }, children: [
          "Ask me where to find something \u2014 e.g., ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { style: { color: accent }, children: '"How do I invite a teammate?"' }),
          " or",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { style: { color: accent }, children: ' "Where do I update my billing email?"' }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 14, fontSize: 11, color: "#5e6675" }, children: "Tap the mic to speak." })
        ] }),
        messages.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
        ...
        busy && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: "#8b93a7", fontSize: 12 }, children: "thinking\u2026" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit, style: { display: "flex", gap: 8, padding: 12, borderTop: "1px solid #1c2230", background: "#0a0d14" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
