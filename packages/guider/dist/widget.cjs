  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { style: { padding: "14px 16px", borderBottom: "1px solid #1c2230", display: "flex", alignItems: "center", gap: 10 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "aria-hidden": "true", style: { width: 8, height: 8, borderRadius: 4, background: accent, boxShadow: `0 0 12px ${accent}` } }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { role: "log", "aria-label": "Conversation", style: { flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 10 }, children: [
            messages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { color: "#8b93a7", fontSize: 13, lineHeight: 1.55 }, children: [
              greeting,
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 14, fontSize: 11, color: "#5e6675" }, children: [
            ...
            (busy || agentRunning) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: "#8b93a7", fontSize: 12 }, children: agentRunning ? "agent running\u2026" : "thinking\u2026" })
          ] }),
